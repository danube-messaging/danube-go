...
func (UnimplementedDiscoveryServer) TopicLookup(context.Context, *TopicLookupRequest) (*TopicLookupResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TopicLookup not implemented")
}
func (UnimplementedDiscoveryServer) TopicPartitions(context.Context, *TopicLookupRequest) (*TopicPartitionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TopicPartitions not implemented")
}
...
const (
	AuthService_Authenticate_FullMethodName = "/danube.AuthService/Authenticate"
)
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "danube.AuthService",
